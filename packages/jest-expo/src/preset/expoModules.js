  ...
  NativeUnimoduleProxy: {
    ...
    exportedMethods: {
      ...
      mock: {
        ...
        ExponentFacebook: [
          { key: 0, argumentsCount: 0, name: 'getPermissionsAsync' },
          { key: 1, argumentsCount: 0, name: 'logOutAsync' },
          { key: 2, argumentsCount: 1, name: 'initializeAsync' },
          { key: 3, argumentsCount: 1, name: 'setAdvertiserTrackingEnabledAsync' },
          { key: 4, argumentsCount: 0, name: 'getAuthenticationCredentialAsync' },
          { key: 5, argumentsCount: 1, name: 'setAutoLogAppEventsEnabledAsync' },
          { key: 6, argumentsCount: 0, name: 'requestPermissionsAsync' },
          { key: 7, argumentsCount: 1, name: 'logInWithReadPermissionsAsync' },
          { key: 8, argumentsCount: 1, name: 'setAdvertiserIDCollectionEnabledAsync' },
        ],
        ExponentFileSystem: [
        ...
        ExponentImagePicker: [
          ...
          { key: 2, argumentsCount: 1, name: 'launchImageLibraryAsync' },
          { key: 3, argumentsCount: 1, name: 'getMediaLibraryPermissionsAsync' },
